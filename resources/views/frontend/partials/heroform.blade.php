                ...
                <div class="row">
                  ...
                  <div class="col-md-12">
                    <div class="single-input">
                      ...
                      <input type="text" id="number" name="number" class="form-input" placeholder="Phone Number">
                  ...
                  <div class="col-md-12">
                    <div class="single-input">
                      ...
                      <input type="text" id="subject" name="subject" class="form-input" placeholder="Company Name">
                  ...
                  <div class="col-md-12">
                    <div class="single-input">
                      ...
                      <textarea name="message" id="message" class="form-input" placeholder="Message" rows="5"></textarea>
